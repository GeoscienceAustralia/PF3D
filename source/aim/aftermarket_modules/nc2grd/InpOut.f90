...
!
	  ...
	  integer(ip), parameter  :: nres = 12     ! Model results file    
!
!***  File names
!
      character(len=s_file) :: flog,finp,fres,fname,fgrd
!
!***  Results and plot properties
!
      character(len=5     ) :: h
      character(len=5     ) :: flm
      character(len=s_mess) :: name 
      character(len=s_file) :: title  
!
!***  List of Warnings 
!

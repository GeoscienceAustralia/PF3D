...
Mass_eruption_rate = (1e8, 1e9)                 # kg/s
Source_type = ('plume', 'suzuki')               # Options are 'plume', 'suzuki', 'point'
Height_above_vent = 40000                       # m (suzuki and point only)            
A = 0                                           # (suzuki only)            
L = 0                                           # (suzuki only)            
